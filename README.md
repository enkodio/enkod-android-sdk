...
2. В файл **build.gradle.kts** (Module:app) в блок dependencies необходимо добавить зависимость `com.github.com:enkodio:androidsdk:1.0.0` и выполнить синхронизацию gradle
