# Инструкция подключения библиотеки enKod Android SDK
 ...
 > Последняя версия библиотеки com.github.enkodio:enkod-android-sdk:v1.1.3
...
2. В файл **build.gradle.kts** (Module:app) в блок dependencies необходимо добавить зависимость `com.github.enkodio:enkod-android-sdk:v1.1.3` и выполнить синхронизацию gradle
