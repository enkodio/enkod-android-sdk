# Инструкция подключения библиотеки enKod Android SDK
 ...
 > Последняя версия библиотеки com.github.enkodio:enkod-android-sdk:v1.1.4
...
2. В файл **build.gradle.kts** (Module:app) в блок dependencies необходимо добавить зависимость `com.github.enkodio:enkod-android-sdk:v1.1.4` и выполнить синхронизацию gradle
